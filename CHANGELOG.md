...
## 2026-05-13
- **Clip button on the soundboard** — the top-bar gains a 📎 Clip button with quick duration picks (10 s / 30 s / 1 min / 2 min) and a "Manage clips…" entry. Clicking a duration captures from the rolling buffer and auto-opens the Clips modal scrolled to the new clip. Same capture path as `/clip` in Discord, available to anyone logged in.
