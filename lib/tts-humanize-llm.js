...
async function _httpHumanize(text) {
    ...
    const body = {
        ...
        temperature: 0.4,
        max_tokens: Math.max(400, Math.ceil(text.length * 2)),
        ...
        // TTS messages are short; cap Ollama's KV context at 4K to keep VRAM
        // down. Default 32K for Qwen3 costs ~7.8 GB that we don't need when
        // Fish is already occupying 19 GiB.
        num_ctx: 4096,
        stream: false,
    };
