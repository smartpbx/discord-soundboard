...
const STYLES = {
    ...
    steve_brule: {
        aliases: ['steve brule', 'stevebrule', 'dr steve brule', 'john c reilly'],
        style: [
            'Earnest but slightly off-kilter — over-explains the obvious as if just discovering it.',
            'Catchphrases sparingly: "for your health", "doctor", "yes yes", "my brand". Only one per sentence.',
            'Short sentences with awkward restarts and odd emphasis on mundane words.',
            'Minimal "uhh" — weird beats of silence do the work instead. Voice model handles the cadence, don\'t respell words.',
        ].join(' '),
    },
