...
const STYLES = {
    ...
    trump: {
        ...
        style: [
            'Short, punchy sentences. Heavy repetition ("very, very", "so, so").',
            'Signature fillers: "believe me", "folks", "tremendous", "the best", "many people are saying".',
            'NO "uhhh"/"ummm" — he speaks in confident declarations, not hesitations.',
            'Occasional "— and by the way —" mid-sentence asides are fine.',
            'Exclamation marks welcome. Sentences often end flat-declarative, not questioning.',
        ].join(' '),
    },
