...
function _spawnQueuedJob(meta, resumePrompt) {
    ...
    console.log('[voice-trainer] spawning claude — has CLAUDE_CODE_OAUTH_TOKEN:',
        !!_spawnEnv.CLAUDE_CODE_OAUTH_TOKEN,
        'len:', (_spawnEnv.CLAUDE_CODE_OAUTH_TOKEN || '').length,
        'tail:', (_spawnEnv.CLAUDE_CODE_OAUTH_TOKEN || '').slice(-12));
